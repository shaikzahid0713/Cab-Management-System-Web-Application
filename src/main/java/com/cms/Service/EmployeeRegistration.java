...
import com.cms.DAO.employeeRegisterDao;
import com.cms.DAO.employeeRegisterDaoImpl;
...
public class EmployeeRegistration extends HttpServlet {
    ...
    protected void doPost (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        employeeRegisterDao rEmp = new employeeRegisterDaoImpl();

        boolean confirm = rEmp.registerEmployee(emp);
